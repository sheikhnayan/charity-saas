        ...
        <div class="row">
            ...
            <div class="col-md-6 mobile mb-4 items" style="display: none;">
                ...
                <div class="row mt-4" style="padding-left: 10px;">
                    ...
                    <div class="col-md-4 col-4 mt-2">
                        ${{ number_format((($data->amount / 100) * $processingFee), 2, '.', ',') }}
                    </div>
                    ...
                    <div class="col-md-4 col-4 mt-4">
                        <h5 style="font-weight: bold;" id="checkout-total">${{ number_format(((($data->amount / 100) * $processingFee) + $data->amount), 2, '.', ',') }}
                        </h5>
                    </div>
                </div>
                {{-- <p>
            ...
            <div class="col-md-6 desktop">
                ...
                <div class="row mt-4" style="padding-left: 10px;">
                    ...
                    <div class="col-md-4 col-4 mt-4">
                        <h5 style="font-weight: bold;" id="checkout-total-desktop">${{ number_format(((($data->amount / 100) * $processingFee) + $data->amount), 2, '.', ',') }}
                        </h5>
                    </div>
                </div>
                {{-- <p>
