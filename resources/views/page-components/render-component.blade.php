        ...
        @case('custom-html')
            ...
            <div class="custom-html-component" id="{{ $componentId }}" style="{{ $customHtmlStyleStr }}overflow: visible; margin-top: 30px !important;">
                <iframe 
                    ...
                    scrolling="no"
                    loading="{{ !empty($isNested) ? 'eager' : 'lazy' }}"
                    data-fallback-height="{{ $height }}"
                ...
                <script>
                    (function() {
                        ...
                        var fallbackHeight = parseInt(iframe.getAttribute('data-fallback-height'), 10) || 1;
                        var resizeFrameId = null;
                        ...
                        var resizeIframe = function() {
                            try {
                                ...
                                var height = Math.max(bodyHeight, documentHeight, fallbackHeight, 1);
                                var currentHeight = parseInt(iframe.style.height, 10) || 0;
                                if (Math.abs(currentHeight - height) > 1) {
                                    iframe.style.height = height + 'px';
                                }
                            } catch (e) {
                                // Keep silent here, inline onload already logs failures.
                            }
                        };
                        ...
                        var setupObservers = function() {
                            ...
                            try {
                                ...
                                if (typeof MutationObserver !== 'undefined') {
                                    var mutationObserver = new MutationObserver(scheduleResize);
                                    mutationObserver.observe(doc.body, {
                                        childList: true,
                                        subtree: true,
                                        attributes: true,
                                ...
                                // Ignore observer errors; resizing still runs on timeouts/events.
                            }
                        };
                        ...
                        iframe.addEventListener('load', function() {
                            ...
                            setTimeout(scheduleResize, 500);
                            setTimeout(scheduleResize, 1000);
                            setTimeout(scheduleResize, 2000);
                        });

                        // If iframe is already loaded (common in dynamic header render), force-init.
                        setTimeout(function() {
                            setupObservers();
                            scheduleResize();
                        }, 0);
