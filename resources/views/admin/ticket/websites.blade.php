                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div class="page-title-icon">
                                        <i class="fas fa-ticket-alt icon-gradient bg-arielle-smile"></i>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="page-title-subheading">
                                            Select a website to manage its tickets
                                        </div>
                                    </div>
                            ...
                            <div class="page-title-subheading opacity-10 mt-3"
                                ...
                                <nav class="" aria-label="breadcrumb">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example" style="float: right">
                                        <a href="{{ route('admin.ticket-category.index') }}" class="btn btn-outline-primary">Manage Categories</a>
                                            ...
                                            @else
                                                @foreach ($data as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.ticket.index', $item->id) }}" class="btn btn-primary">
                                                                <i class="fa fa-ticket-alt"></i> Manage Tickets
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
