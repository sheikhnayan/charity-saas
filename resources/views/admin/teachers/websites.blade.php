                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div class="page-title-icon">
                                        <i class="fas fa-chalkboard-teacher icon-gradient bg-arielle-smile"></i>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="page-title-subheading">
                                            Select a website to manage its teachers
                                        </div>
                                    </div>
                                            ...
                                            @else
                                                @foreach ($data as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.teachers.index', $item->id) }}" class="btn btn-primary">
