                ...
                <form action="{{ route('stripe.post') }}" method="POST" id="payment-form"
                    ...
                    <div class="sc-gyZVQB fWNGEI mt-4">
                        <div class="sc-cVAmsi cvolSU"><button type="submit"
                                ...
                                class="btn btn-primary" id="pay-btn">Pay Now <i class="fas fa-arrow-right" style="margin-left: 0.5rem;"></i></button>
                        </div>
                    </div>
...
<script>
    // Initialize Stripe with publishable key (passed from controller)
